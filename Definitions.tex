...
\begin{statement}[связь знака производной с монотонностью]
    ...
    \begin{enumerate}
        ...
        \item $f'(x)<0 \implies f(x)$ - убывает $\implies f'(x) \geqslant 0$;
        \item $f'(x)\leqslant0 \implies f(x)$ - не возрастает $\implies f'(x) \geqslant 0$;
    \end{enumerate}
\end{statement}
...
\section{Производная функции по вектору}
Текст
